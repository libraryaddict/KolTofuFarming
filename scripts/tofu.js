...
Tofu = /*#__PURE__*/function () {function Tofu() {_classCallCheck(this, Tofu);_defineProperty(this, "adventuresValuedAt",
    ...
    1000);_defineProperty(this, "onlyAddNoReprice",
    false);_defineProperty(this, "breakfastScript",
    ...
    function loadProperties() {
      ...
      this.onlyAddNoReprice = (0,external_kolmafia_namespaceObject.toBoolean)(
    ...
    function doQuickCheck() {
      ...
      if (!(0,external_kolmafia_namespaceObject.propertyHasDefault)("_monkeyPawWishesUsed")) {
        (0,external_kolmafia_namespaceObject.print)("Need to update mafia!");
        passed = false;
      }
    ...
    function doMonkeyWishes() {
      ...
      {
        (0,external_kolmafia_namespaceObject.visitUrl)("main.php?action=cmonk&pwd");

        for (var i = 0; i < 5; i++) {
          (0,external_kolmafia_namespaceObject.visitUrl)("choice.php?whichchoice=1501&pwd&wish=In+Your+Cups&option=1",
    ...
    function doFarming() {
      ...
      if (this.isFarmingDay()) {
        ...
        (0,external_kolmafia_namespaceObject.haveEffect)(external_kolmafia_namespaceObject.Effect.get("In Your Cups")) >= 10)
        {
          ...
          var monkeyBanish = external_kolmafia_namespaceObject.Monster.get("Essence of Interspecies");
        ...
        (0,external_kolmafia_namespaceObject.print)("Charging day! Of ".concat(
          ...
          0,
          (0,external_kolmafia_namespaceObject.myAdventures)() - adventuresToKeep
    ...
    function doStock() {
      ...
      var ourLimit = this.onlyAddNoReprice ?
      ...
      if (to_sell > 0) {
        ...
        (0,external_kolmafia_namespaceObject.shopAmount)(tofu) > this.sellbotOverflow)
        {
          (0,external_kolmafia_namespaceObject.print)("We have ".concat(
            this.getNumber(
              (0,external_kolmafia_namespaceObject.shopAmount)(tofu)
            ), " tofu in mall, our overflow is ").concat(this.getNumber(
            this.sellbotOverflow
          ), " so lets send ").concat(this.getNumber(to_sell), " excess tofu to sellbot!"),
          "purple"
          );
    ...
    function getShopPrice() {
      ...
      if (this.onlyAddNoReprice) {
        return (0,external_kolmafia_namespaceObject.shopAmount)(tofu) > 0 ? (0,external_kolmafia_namespaceObject.shopPrice)(tofu) : 999999999;
      }
